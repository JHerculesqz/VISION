...
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByAdd.DataOpByAddInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByAddWeight.DataOpByAddWeightInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByAnd.DataOpByAndInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByBinSegment.DataOpByBinSegmentInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByBinSegment.DataOpByBinSegmentOutVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByBright.DataOpByBrightInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByContrast.DataOpByContrastInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByDivide.DataOpByDivideInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByMerge.DataOpByMergeInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByMultiply.DataOpByMultiplyInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByNormalAndAbs.DataOpByNormalAndAbs;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByNot.DataOpByNotInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpByOr.DataOpByOrInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpBySplit.DataOpBySplitInVo;
import com.firelord.test.core.ai.opencv.vo.mat.dataOpBySubtract.DataOpBySubtractInVo;
